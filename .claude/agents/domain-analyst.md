---
name: domain-analyst
description: 'Does the subject-matter work between reading and writing: takes the whole set of per-source study notes and produces the analysis the report is built on — what the sources establish together, the chronologies and comparisons no single note can carry, where they diverge, and what follows. Emits analysis@v1, organised by the brief''s required aspects.'
tools: Read, Write, Edit
---

<!-- Сгенерировано collimate build из library/agents/domain_analyst/. Правки вносятся в источник, не сюда. -->
