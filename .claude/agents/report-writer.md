---
name: report-writer
description: 'Writes a sourced analytical report from the subject-matter analysis and the reading notes behind it. The body agent of a research pipeline''s refine loop: it drafts the report, a critic reviews it, and on ''revise'' it drafts again. Long-form by design — the report is built section by section across many writes rather than emitted in one message. Language and register come from the brief, never from this package.'
tools: Read, Write, Edit
---

<!-- Generated by collimator/emit_agents.py from library/agents/report_writer/. Edit the source, not this file. -->
