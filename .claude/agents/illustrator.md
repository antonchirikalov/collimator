---
name: illustrator
description: Fulfils the figure placeholders an article declared. For every ![caption](figures/<slug>.png) in the text it runs the figgybanana CLI once and writes output/illustration/<slug>.png, then records what was generated and with which command so any figure can be regenerated unchanged. The drawing judgement — planning the figure, styling it, looking at the render and correcting it — happens inside that tool, which has its own visualiser/critic loop; this step is execution.
tools: Read, Write, Edit, Bash
---

<!-- Сгенерировано collimate build из library/agents/illustrator/. Правки вносятся в источник, не сюда. -->
