...
## Веер исследования: два уровня имён
...
дальше **аналитик и сверяющий с заметками получают все**, а писатель — по-прежнему четыре сводки
плюс материал, чтобы не платить за 260 КБ на каждом круге. Перечисление — не то же самое, что
спросить путь: скрипт по-прежнему сам называет всё, что пишет, а это только отчёт о том, что
есть.
