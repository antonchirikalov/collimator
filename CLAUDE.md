...
`run-<время>` — имя, не отличающее ничего. **Продолжение прерванного прогона — это осознанная
передача его каталога обратно, и теперь это выглядит иначе, чем запуск нового.**
